...
class Mycervical(tfds.core.GeneratorBasedBuilder):
  ...
  manual_dir should contain onw file: CIFAR-10BINA.tar.gz
  """
  ...
  def _split_generators(self, dl_manager):
    ...
    #mycervical_path = dl_manager.download_and_extract(self.mycervical_path.url)
